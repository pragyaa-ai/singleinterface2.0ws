# 🔄 v4.3.0 Webhook Updates Summary
...
#### **Parameters Sent:**
- **customer_name** (if captured)
- **car_model** (if captured)
- **customer_email** (if captured)
- **call_status** (always - complete/partial/incomplete)
- **call_duration_seconds** (if available)
- **conversation_language** (if detected)
